/**
 * @file ScrapeInspector.js
 * @description Sidebar panel "CASE DATA" showing structured case data from
 ...
 * @namespace app.Features.ScrapeInspector
 */
...
(function () {
    ...
    app.Features.ScrapeInspector = ScrapeInspector;
